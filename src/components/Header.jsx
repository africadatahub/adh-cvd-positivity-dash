            ...
            <div className="bg-white shadow fixed-top py-3">
                <Container>
                    <Row className="justify-content-between">
                        <Col>
                            <a href="#"><img src={logo} style={{height: '45px'}}/></a>
                        </Col>
                        <Col xs="auto" className="navlinks">
                            ...
                            <Button variant="white" onClick={() => { location.href='https://www.africadatahub.org/blog'}}>Blog</Button>
